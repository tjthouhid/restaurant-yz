  <!-- ****************************************** -->
    ...
    <div id="menu-sideBar" class="sidenav">
        ...
        <ul class="menu">
            ...
            <li <?php if($current_url=="landing-page.php"){ ?> class="active" <?php } ?>><a href="landing-page.php">Reservation</a></li>
            <li <?php if($current_url=="menu.php"){ ?> class="active" <?php } ?>><a href="menu.php">Menu</a></li>
            <li <?php if($current_url=="blog.php"){ ?> class="active" <?php } ?>><a href="#">Blog</a></li>
        </ul>
