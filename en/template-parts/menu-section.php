  <!-- ****************************************** -->
    ...
    <section class="menu_section" id="menu">
        <div class="container-fluid">
            <h2 class="header-2 text-center" data-anijs="if: mouseover, do: swing animated">Our Offering Recipies</h2>
            <div class="row">
                     ...
                     <div class="menu-tab">
                       ...
                       <ul class="nav nav-tabs" role="tablist">
                        <?php 
                         ...
                         ?>
                         <li role="presentation" <?php if($i<1){ ?> class="active" <?php } ?>><a href="#<?php echo $rowm->slug;?>" aria-controls="<?php echo $rowm->slug;?>" role="tab" data-toggle="tab"><?php echo$rowm->english;?> </a></li>
                         <?php $i++;} ?>
                         ...
                         <div role="tabpanel" class="tab-pane fade in <?php if($k<1){ ?> active <?php } ?>" id="<?php echo $array_cat['slug'];?>"> 
                            ...
                            <div class="row item">
                                ...
                                <div class="col-md-6 col-xs-6 set-full">
                                    <h3 class="header-3"><?php echo $rowm2->title_en;?></h3>
                                    <p class="p-text-1">
                                        <?php echo $rowm2->detail_en;?> 
                                    </p>
                                </div>
                                <div class="col-md-3 col-xs-3 set-full">
                                    <div class="price-box">
