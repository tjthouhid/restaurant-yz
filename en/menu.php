                        ...
                        <div id="head-text-slide" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    ...
                                    <h6 class="header-6">Reserve Your table now and get 15% discount.</h6>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="single-menu-bar">
                                <h3 class="header-3V2"><?php echo $row->english;?></h3>
                                <ul>
                                    ...
                                    <li class="single-menu-item <?php echo $cls;?>">
                                        <div class="row">
                                            <div class="col-md-8 col-xs-8">
                                                <h2 class="single-menu-header"><?php echo $row2->title_en;?></h2>
                                            </div>
    ...
    <section class="single-menu-sec double-row-menu">
        <div class="container-fluid fix">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="single-menu-bar">
                        <h3 class="header-3V2"><?php echo $rowd->english;?></h3>
                        <ul>
                            ...
                            <li class="single-menu-item <?php echo $cls;?>">
                                <div class="row">
                                    <div class="col-md-8 col-xs-8">
                                        <h2 class="single-menu-header"><?php echo $rowd2->title_en;?></h2>
                                    </div>
                                    <div class="col-md-4 col-xs-4 price">
    ...
    <section class="single-menu-sec double-row-menu">
        <div class="container-fluid fix">
            <div class="row">
                <div class="col-md-6">
                    <div class="single-menu-bar">
                        <h3 class="header-3V2">Red View</h3>
                        <ul>
                            <li class="single-menu-item">
                                <div class="row">
                                    <div class="col-md-8 col-xs-8">
                                        <h2 class="single-menu-header">Chicken Kababiya with chips</h2>
                                    </div>
                                    <div class="col-md-4 col-xs-4 price">
                                        $25
                                    </div>
                            ...
                            <li class="single-menu-item">
                                <div class="row">
                                    <div class="col-md-8 col-xs-8">
                                        <h2 class="single-menu-header">Kababiya with chips</h2>
                                    </div>
                                    <div class="col-md-4 col-xs-4 price">
                                        $25
                                    </div>
                            ...
                            <li class="single-menu-item">
                                <div class="row">
                                    <div class="col-md-8 col-xs-8">
                                        <h2 class="single-menu-header">Noddus Kababiya chips</h2>
                                    </div>
                                    <div class="col-md-4 col-xs-4 price">
                                        $25
                                    </div>
                            ...
                            <li class="single-menu-item not-show">
                                <div class="row">
                                    <div class="col-md-8 col-xs-8">
                                        <h2 class="single-menu-header">Chicken Kababiya with chips</h2>
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="single-menu-bar">
                        <h3 class="header-3V2">White View</h3>
                        <ul>
                            <li class="single-menu-item">
                                <div class="row">
                                    <div class="col-md-8 col-xs-8">
