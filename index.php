<?php include "includes/header.php";?>
    ...
    <?php include "template-parts/reservation-section.php"; ?>

    <?php include "template-parts/testimonial-section.php"; ?>

    <?php include "template-parts/insider-section.php"; ?>

    <?php include "template-parts/instagram-section.php"; ?>
